...
(() => {
  "use strict";
  const TITLES = { shield: "Конфигуратор щита", materials: "Материалы", work: "Работа", scheme: "Однолинейная схема", settings: "Настройки", subscription: "Подписка", admin: "Админка" };
