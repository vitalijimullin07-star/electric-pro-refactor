...
(() => {
  ...
  function injectCss() {
    ...
    st.textContent = `
      ...
      .ms-fsclose{width:34px;height:30px;border:1px solid #ef4444;background:#fee2e2;color:#b91c1c;border-radius:7px;font:800 14px/1 system-ui;cursor:pointer}
      ...
      .ms-inrow{display:flex;gap:10px;flex-wrap:wrap}.ms-inrow label{flex:1 1 96px;min-width:96px;font:600 11px/1.3 system-ui;color:#334155;display:flex;flex-direction:column;gap:3px}
      .ms-inrow select{width:100%;height:40px;border:1px solid #cbd5e1;border-radius:10px;padding:0 26px 0 11px;font:600 13px/1 system-ui;background:#fff;color:#0f172a;-webkit-appearance:none;appearance:none;background-image:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='10' height='6' viewBox='0 0 10 6'><path d='M1 1l4 4 4-4' stroke='%230f172a' stroke-width='1.6' fill='none'/></svg>");background-repeat:no-repeat;background-position:right 9px center}.ms-gsel{flex:0 1 auto;width:auto;min-width:54px;max-width:104px;height:32px;border:1px solid #94a3b8;border-radius:8px;padding:0 18px 0 7px;font:700 12px/1 system-ui;background:#fff;color:#0f172a;-webkit-appearance:none;appearance:none;background-image:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='10' height='6' viewBox='0 0 10 6'><path d='M1 1l4 4 4-4' stroke='%230f172a' stroke-width='1.6' fill='none'/></svg>");background-repeat:no-repeat;background-position:right 5px center}.ms-group-row .ms-seg{flex:0 0 auto}.ms-leak select,.ms-gtitle,.ms-line-name,.ms-line-nom{height:38px;border:1px solid #cbd5e1;border-radius:9px;padding:0 10px;font:600 13px/1 system-ui;background:#fff;color:#0f172a}
      .ms-seqrow{margin:0 0 10px}.ms-seqitem{display:flex;align-items:center;gap:8px;background:#eef2ff;border:1px solid #c7d2fe;border-radius:9px;padding:5px 8px;margin-bottom:5px}[data-draghandle]{touch-action:none;cursor:grab}.ms-chgrip{font-style:normal;color:#94a3b8;cursor:grab;font-size:12px;padding:0 1px;line-height:1}.ms-dragging{opacity:.65;box-shadow:0 3px 12px rgba(0,0,0,.28)}.ms-draglist{display:inline-flex;flex-wrap:wrap;gap:6px;align-items:center;vertical-align:middle}.ms-draglist-v{display:block}.ms-seqnum{font:800 11px/1 system-ui;color:#4338ca;background:#c7d2fe;border-radius:50%;width:18px;height:18px;display:inline-flex;align-items:center;justify-content:center;flex:none}.ms-seqbtns{display:inline-flex;gap:4px;flex:none;margin-left:auto}.ms-seqcab{display:flex;align-items:center;gap:6px;margin:0 0 6px 16px}.ms-segcab{flex:1;min-width:0;max-width:230px;height:30px;border:1px solid #86efac;border-radius:8px;padding:0 8px;font:600 11px/1 system-ui;background:#f0fdf4;color:#166534}.ms-seqhint{font:600 11px/1.3 system-ui;color:#64748b;margin-bottom:6px}.ms-seqchips{display:flex;flex-wrap:wrap;gap:6px}.ms-seqchip{display:inline-flex;align-items:center;gap:4px;background:#eef2ff;border:1px solid #c7d2fe;border-radius:9px;padding:3px 4px 3px 6px}.ms-seqname{font:700 12px/1 system-ui;color:#1e293b;flex:1}.ms-seqmove{border:0;background:#c7d2fe;color:#1e293b;border-radius:6px;width:22px;height:22px;font-size:11px;cursor:pointer;line-height:1}.ms-seqmove:disabled{opacity:.35}.ms-seqx{border:0;background:#fecaca;color:#7f1d1d;border-radius:6px;width:22px;height:22px;font-size:11px;cursor:pointer;line-height:1}.ms-chips{display:flex;flex-wrap:wrap;gap:7px}
      ...
      .ms-line-cv,.ms-line-amp{height:38px;border:1.5px solid #64748b;border-radius:8px;font:800 13px/1 system-ui;color:#0f172a;background:#fff;-webkit-appearance:none;appearance:none;background-image:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='10' height='6' viewBox='0 0 10 6'><path d='M1 1l4 4 4-4' stroke='%230f172a' stroke-width='1.6' fill='none'/></svg>");background-repeat:no-repeat;background-position:right 6px center;padding:0 18px 0 8px;text-align:center;text-align-last:center}
      .ms-line-cv{width:58px;height:38px;border:1.5px solid #64748b;border-radius:8px;font:800 13px/1 system-ui;color:#0f172a;background:#fff;-webkit-appearance:none;appearance:none;background-image:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='10' height='6' viewBox='0 0 10 6'><path d='M1 1l4 4 4-4' stroke='%230f172a' stroke-width='1.6' fill='none'/></svg>");background-repeat:no-repeat;background-position:right 5px center;padding:0 16px 0 8px;text-align:center;text-align-last:center}.ms-line-amp{width:78px}.ms-addbrand{flex:none;align-self:flex-end;height:38px;border:1px dashed #6366f1;background:#eef2ff;color:#4338ca;border-radius:9px;padding:0 12px;font:700 12px/1 system-ui;cursor:pointer}.ms-apps{display:flex;flex-wrap:wrap;gap:6px;align-items:center;margin:6px 0 4px;padding-left:2px}.ms-apps-line{padding-left:8px}.ms-apps-lbl{font:700 10.5px/1 system-ui;color:#64748b;margin-right:2px}.ms-apps-none{color:#cbd5e1;font:700 11px/1 system-ui}.ms-app-chip{display:inline-flex;align-items:center;gap:3px;background:#fff7ed;border:1px solid #fdba74;color:#9a3412;border-radius:999px;padding:3px 6px;font:700 11px/1 system-ui}.ms-chnm{padding:0 1px}.ms-chmv{font-style:normal;cursor:pointer;color:#9a3412;background:#fed7aa;border-radius:50%;width:16px;height:16px;display:inline-flex;align-items:center;justify-content:center;font-size:8px}.ms-chmv.ms-chdis{opacity:.3;pointer-events:none}.ms-chx{font-style:normal;cursor:pointer;color:#dc2626;background:rgba(220,38,38,.12);border-radius:50%;width:16px;height:16px;display:inline-flex;align-items:center;justify-content:center;font-size:9px}.ms-phase{transform:scale(.9)}.ms-phase button{padding:7px 10px;font:700 11px/1 system-ui}.ms-app-add{height:32px;border:1px dashed #fb923c;background:#fff;color:#9a3412;border-radius:8px;padding:0 8px;font:700 11px/1 system-ui;cursor:pointer}.ms-viewseg{transform:scale(.92)}.ms-viewseg button{padding:6px 10px;font:800 11px/1 system-ui}.ms-prev-tools{display:inline-flex;gap:6px;align-items:center;flex-wrap:wrap}.ms-zoom{width:34px;height:30px;border:1px solid #0ea5e9;background:#e0f2fe;color:#0369a1;border-radius:7px;font:800 15px/1 system-ui;cursor:pointer}.ms-cabrow{padding-left:6px}.ms-cabic{flex:none;font-size:14px;opacity:.6}.ms-cab{flex:1;min-width:0;height:34px;border:1px solid #cbd5e1;border-radius:8px;padding:0 8px;font:600 12px/1 system-ui;background:#fff;color:#0f172a}.ms-clen{width:64px;height:34px;border:1px solid #cbd5e1;border-radius:8px;padding:0 8px;font:600 12px/1 system-ui;text-align:center;color:#0f172a}
